package com.security6.security.config;
...
import static com.security6.security.user.Permission.*;
import static com.security6.security.user.Role.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(GET, "/**").hasAnyAuthority(ADMIN_READ.name(), MANAGER_READ.name())
